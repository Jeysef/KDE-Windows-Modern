...
const iconMargin = Math.round(Kirigami.Units.smallSpacing / 6);
const labelMargin = Kirigami.Units.smallSpacing;

function horizontalMargins() {
    const spacingAdjustment = (tasks.plasmoid.pluginName === "org.kde.windowsmodern.icontasks") ? tasks.plasmoid.configuration.iconSpacing : 1
